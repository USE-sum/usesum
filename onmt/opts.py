...
def model_opts(parser):
    ...
    group.add_argument('-model_type', default='text',
                       ...
                       Options are [text|img|audio|vector].""")
    ...
    group.add_argument('-decoder_type', type=str, default='rnn',
                       choices=['rnn', 'transformer', 'cnn', 'vector', 'vecdif', 'vecdif_multi'],
                       help="""Type of decoder layer to use. Non-RNN layers
                       are experimental. Options are
                       [rnn|transformer|cnn|vector|vecdif|vecdif_multi].""")

    group.add_argument('-use_port', type=str, default='',
                       help="""If non empty, input text will be converted 
                       into use vectors using local server and port here given.""")
    ...
    group.add_argument('-rnn_size', type=int, default=-1,
                       ...
                       enc_rnnbridge_size and dec_rnn_size""")
    ...
    group.add_argument('-dec_rnn_size', type=int, default=500,
                       ...
                       speech-to-text.""")
    # group.add_argument('-final_vec_size', type=int, default=512,
    #                    help="""Size of the final vector of the vector generating model""")
    ...
    group.add_argument('-generator_function', default="log_softmax",
                       choices=["log_softmax", "sparsemax", "sigmoid", "none"],
    ...
    group.add_argument('-focal_gamma', type=float, default=0,
                       help='Focal loss gamma modifier.')
...
def preprocess_opts(parser):
    ...
    group.add_argument('-tgt_vocab', default="",
                       ...
                       one word per line.""")
    group.add_argument('-src_vocab_extend', default="",
                       help="""Path to an existing source vocabulary which will be added to vocab. Format:
                           one word per line.""")
    group.add_argument('-tgt_vocab_extend', default="",
                       help="""Path to an existing target vocabulary which will be added to vocab. Format:
                           one word per line.""")
...
def train_opts(parser):
    ...
    group.add_argument('-force_target_split', default=False, action='store_true',
                       help="""Split target by sentences or not.""")
...
def translate_opts(parser):
    ...
    group = parser.add_argument_group('Data')
    group.add_argument('-data_type', default="text",
                       help="Type of the source input. Options: [text|img|vector].")
    group.add_argument('-decoder_type', type=str, default='rnn',
                       choices=['rnn', 'transformer', 'cnn', 'vector', 'vecdif', 'vecdif_multi'],
                       help="""Type of decoder layer to use. Non-RNN layers
                           are experimental. Options are
                           [rnn|transformer|cnn|vector|vecdif|vecdif_multi].""")
    group.add_argument('-use_host', type=str, default='localhost',
                       help="""USE server""")
    group.add_argument('-use_port', type=str, default='',
                       help="""If non empty, input text will be converted 
                               into use vectors using local server and port here given.""")
    group.add_argument('-use_path', type=str, default='v1/models/universal_encoder:predict',
                       help="""Default path to infer USE vectors""")
    group.add_argument('-force_target_split', default=False, action='store_true',
                       help="""Split target by sentences or not.""")
    ...
    group.add_argument('-n_best', type=int, default=1,
                       ...
                       decoded sentences""")
    group.add_argument('-translate_size', type=int, default=-1,
                       help="""If >0 only the given amount of test utterances will be measured""")
    ...
    group.add_argument('-sentence_separator', type=str, default="",
                       help='Sentence separator for vector USE predictions.')
...
def vocab_compare_opts(parser):
    ...
    group.add_argument('-data', required=True,
                       help="""Path prefix to the ".train.pt" and
                       ".valid.pt" file path from preprocess.py""")
    group.add_argument('-data2', required=True,
                       help="""Path prefix to the second ".train.pt" and
                           ".valid.pt" file path from preprocess.py""")
